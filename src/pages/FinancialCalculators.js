...
const sections = [
  ...
  },
  {
    ...
    items: [
      { label: 'Currency Calculator',              to: '/currency' },
      { label: 'Finance Calculator',               to: '/finance' },
      { label: 'Budget Calculator',                to: '/budget' },
      { label: 'House Affordability Calculator',   to: '/house-affordability' },
      { label: 'Rent Calculator',                  to: '/rent' },
      { label: 'Rent vs. Buy Calculator',          to: '/rent-vs-buy' },
      { label: 'Rental Property Calculator',       to: '/rental-property' },
      { label: 'Real Estate Calculator',           to: '/real-estate' },
      { label: 'Present Value Calculator',         to: '/present-value' },
      { label: 'Future Value Calculator',          to: '/future-value' },
      { label: 'Discount Calculator',              to: '/discount' },
      { label: 'Depreciation Calculator',          to: '/depreciation' },
      { label: 'Margin Calculator',                to: '/margin' },
      { label: 'Cash Back or Low Interest Calculator', to: '/cash-back' },
      { label: 'Credit Cards Payoff Calculator',   to: '/credit-card-payoff' },
      { label: 'Credit Card Calculator',           to: '/credit-card' },
      { label: 'Debt Consolidation Calculator',    to: '/debt-consolidation' },
      { label: 'Debt Payoff Calculator',           to: '/debt-payoff' },
      { label: 'Repayment Calculator',             to: '/repayment' },
      { label: 'Debt-to-Income Ratio Calculator',  to: '/debt-ratio' },
      { label: 'College Cost Calculator',          to: '/college-cost' },
      { label: 'Payback Period Calculator',        to: '/payback-period' },
    ],
  },
];
