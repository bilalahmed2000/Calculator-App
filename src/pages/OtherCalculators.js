...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Stair Calculator',          to: '/stair-calculator' },
      { label: 'Roofing Calculator',        to: '/roofing-calculator' },
      { label: 'Tile Calculator',           to: '/tile-calculator' },
      { label: 'Gravel Calculator',         to: '/gravel-calculator' },
      { label: 'Square Footage Calculator', to: '/square-footage-calculator' },
      { label: 'Mulch Calculator',          to: '/mulch-calculator' },
      { label: 'BTU Calculator',            to: '/btu-calculator' },
      { label: 'Fuel Cost Calculator',      to: '/fuel-cost-calculator' },
      { label: 'Gas Mileage Calculator',    to: '/gas-mileage-calculator' },
      { label: 'Mileage Calculator',        to: '/mileage-calculator' },
      { label: 'Tire Size Calculator',      to: '/tire-size-calculator' },
      { label: 'Tip Calculator',            to: '/tip-calculator' },
      { label: 'Sleep Calculator',          to: '/sleep-calculator' },
      { label: 'Heat Index Calculator',     to: '/heat-index-calculator' },
      { label: 'Wind Chill Calculator',     to: '/wind-chill-calculator' },
      { label: 'Dew Point Calculator',      to: '/dew-point-calculator' },
      { label: 'Golf Handicap Calculator',  to: '/golf-handicap-calculator' },
      { label: 'Love Calculator',           to: '/love-calculator' },
      { label: 'Dice Roller',              to: '/dice-roller' },
      { label: 'Bra Size Calculator',       to: '/bra-size-calculator' },
    ],
  },
];
