...
const sections = [
  ...
  },
  {
    ...
    items: [
      { label: 'Quadratic Formula Calculator',    to: '/quadratic' },
      { label: 'Greatest Common Factor Calculator', to: '/gcf' },
      { label: 'Least Common Multiple Calculator', to: '/lcm' },
      { label: 'Factor Calculator',               to: '/factor' },
      { label: 'Half-Life Calculator',            to: '/half-life' },
      { label: 'Matrix Calculator',               to: '/matrix' },
    ],
  },
  {
    ...
    items: [
      ...
      { label: 'Probability Calculator',       to: '/probability' },
      { label: 'Mean Median Mode Range Calculator', to: '/mean-median-mode' },
      { label: 'Z-score Calculator',           to: '/z-score' },
      { label: 'Statistics Calculator',        to: '/statistics' },
      { label: 'Permutation and Combination Calculator', to: '/permutation-combination' },
      { label: 'Confidence Interval Calculator', to: '/confidence-interval' },
      { label: 'Sample Size Calculator',       to: '/sample-size' },
      { label: 'Percent Error Calculator',     to: '/percent-error' },
    ],
  },
];
